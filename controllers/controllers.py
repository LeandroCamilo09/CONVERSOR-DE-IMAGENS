import flet as ft
from model.model import Conversor, pick_files_result, salvar_imagens
...
btn_arquivos=ft.ElevatedButton("Procurar imagem", icon="IMAGE", on_click=lambda _:arquivos.pick_files(allow_multiple=True))
...
programa = ft.Column([title,container_btn_format,container_selected_files,lounding,btn_save], horizontal_alignment= "CENTER")